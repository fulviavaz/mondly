...
export default function Home() {
  ...
  <Link
    ...
    href="https://shop.mondly.com/order/checkout.php?CLEAN_CART=1&CURRENCY=BRL&CART=1&CARD=2&SHORT_FORM=1&ADDITIONAL_B2B_COMPANY_REF=33691%24jTZga1YC7Sfrcc-iHdTo4oywTzfdk01D&PRODS=46420733&QTY=1&PRICES46420733%5BBRL%5D=29.90&PHASH=sha3-256.e360c9adad598c7c75eeec7f6f56e3b3bf03b1209fa0f64769430dfa2466b84b"
    target="_blank"
  >
  ...
  <Link
    className="w-full sm:w-auto h-12 text-left"
    href="https://shop.mondly.com/order/checkout.php?CLEAN_CART=1&CURRENCY=BRL&CART=1&CARD=2&SHORT_FORM=1&ADDITIONAL_B2B_COMPANY_REF=32525%24NSJ8faiZnz4WlzhAQtqN-6zo8jWrqGIs&PRODS=46453293&QTY=1&PRICES46453293%5BBRL%5D=107.28&PHASH=sha3-256.87ab4f89f614a2121f6c524dfa49a3fc5db6c69263b9f3118554ef06583b7b72"
    target="_blank"
  >
    <Button className="bg-[#3D75DB] text-white text-sm font-bold px-6 py-6 w-full sm:w-auto">
